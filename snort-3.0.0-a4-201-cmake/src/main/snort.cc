...
/////////////////////////////////////////////////////////////////////////main_hook在此处赋值
//Snort::set_main_hook()被谁调用呢?
//在Snort::setup()的时候根据命令行给main_hook赋值
//Snort::setup()在哪里?不用找了，就在下面469行
...
////////////////////////////////////////////////////////////////////main_hook()
//上面168 169 声明
//Detect.cc // 68  snort_ignore

//Detect.cc // 70  snort_inspect
//在main_hook() 中到达snort_inspect 
//然后执行六种行为:pass alert log drop block reset

//Detect.cc // 130  snort_log
        main_hook(p);
    }
...
/////////////////////////////////////////////////执行三种情况:react reject replace
    ActionManager::execute(s_packet);

    int inject = 0;
    verdict = update_verdict(verdict, inject); //更新判决
