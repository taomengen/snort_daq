...
/* packet status flags */
#define PKT_REBUILT_FRAG     0x00000001  /* is a rebuilt fragment */ //重建的片段
#define PKT_REBUILT_STREAM   0x00000002  /* is a rebuilt stream */   //重建的流
...
#define PKT_HTTP_DECODE      0x00000400  /* this packet has normalized http */ //这个包有标准的HTTP
...
//wire packet    contains payload data and headers.
//cooked packet  contains payload data only, no headers.
...
struct SO_PUBLIC Packet
{
    ...
    class Endianness* endianness;//字节顺序
    class Obfuscator* obfuscator;//混淆器
